...
public class FrmVehicle extends javax.swing.JFrame {
    ...
    private PnlListVehicles pnlListVehicles;
    ...
    private void btnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewActionPerformed
        if(pnlVehicle == null){
            ...
            {
                JOptionPane.showMessageDialog(pnlContent, e);
            }
        }
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        logger.severe("Estoy en el metodo llamar formulario");
         if(pnlListVehicles == null){
            pnlListVehicles = new PnlListVehicles();
            try {
                pnlListVehicles = new PnlListVehicles();
            }
            catch (Exception e)
